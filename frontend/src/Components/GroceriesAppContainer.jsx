            ...
            await axios.get(`${BASE_URL}/products`).then((result) => {
                ...
                if (filter) {
                    ...
                    setFilteredProductList(() =>
                        result.data.filter((product) => Number(product.price.replace("$", "")) < Number(filter))
                    );
                }
            });
        } catch (error) {
                ...
                e.target.value
                    ? productList.filter(
                          (product) =>
                              ...
                              Number(product.price.replace("$", "")) < Number(e.target.value)
                      )
    ...
    return (
        <div>
            ...
            <div className="GroceriesApp-Container">
                <FilterForm options={filterOptions} selectedFilter={filter} handleSelectFilter={handleSelectFilter} />
                <ProductsContainer
